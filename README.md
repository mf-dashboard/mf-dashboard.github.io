...
**🔗 [my-mf-dashboard.pages.dev](https://my-mf-dashboard.pages.dev/)**
...
Visit: [My MF Dashboard](https://my-mf-dashboard.pages.dev/)
...
- ✅ **HTTPS Only**: Secure communication end to end
...
**NAV Update Fails** — Check if already updated today (timestamps shown in Manage Data).
...
- ✅ Global benchmark data cache — Nifty 50 TRI and Nifty 500 TRI trailing and rolling returns, stored in localStorage, refreshed weekly; powers Performance vs Benchmark table and portfolio alpha in Dashboard and Family Dashboard
- ✅ Left-to-right draw animation on Portfolio History chart (Performance tab) on period switch
- ✅ Goal Planning — define financial goals (target amount, target date, category), map holdings/SIPs to a goal, and track projected vs required corpus with configurable CAGR, step-up, and inflation assumptions; goal data included in backup/restore
...
- Auto-NAV update slots expanded from 2/day to 4/day — 12 AM, 9 AM, 9:30 PM, 12 PM IST — to catch same-evening AMFI NAV publishes sooner
...
**Quick Links**: [Live App](https://my-mf-dashboard.pages.dev/) · [CAMS Portal](https://www.camsonline.com/Investors/Statements/Consolidated-Account-Statement)
